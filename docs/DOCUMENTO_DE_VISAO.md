...
|---	|---	|---  |--- | --- |
|  RF001 	|  Cadastro de Produtos | No RF001 será possivel realizar o cadastro de produtos| codigo, nome, preço, tipo do produto, detalhes do produto (quantidade, tamanho e cor dos produtos) | Alta |
